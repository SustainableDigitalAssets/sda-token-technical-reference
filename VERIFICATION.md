...
6. Confirm the [notified white paper](https://sdafintech.com/legal/mica/whitepaper/SDA-Token-MiCA-Whitepaper-v1.3-2026_07_16.xhtml) identifies DTI `ZHSMZL7F9`, Sustainable Digital Assets Inc., FIN-FSA, and the notification scope covering 29 EEA states. A [PDF version](https://sdafintech.com/legal/mica/whitepaper/SDA-Token-MiCA-Whitepaper-v1.3-2026_07_16.pdf) is also available.
